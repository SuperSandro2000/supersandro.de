{
  ...
  down = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0sx6cg0m6284yqvl4n6d45jlfwh8zyszw8d8ilwxrv5sr8804ka8";
      type = "gem";
    };
    version = "5.3.1";
  };
  ...
  jekyll-octicons = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "03rijs0q1if9kd3x818x51b945hb837p77h91wq40pw3gn9ynmmx";
      type = "gem";
    };
    version = "17.0.0";
  };
  ...
  jekyll-purgecss = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1hby4br1lb8gr32f9x4yphpmf8gcz7ngiwh2cjx7rmkybjkdjcv9";
      type = "gem";
    };
    version = "0.3.0";
  };
  ...
  octicons = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1kss4iq28j7yqfpzrqxczkq1ka1s7iwnairr8swq9pnw07d19qx0";
      type = "gem";
    };
    version = "17.0.0";
  };
